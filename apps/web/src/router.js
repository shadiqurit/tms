    ...
    routes: [
        { path: '/login', name: 'login', component: LoginView, meta: { public: true } },
        {
            ...
            children: [
                ...
                { path: 'finance/engineer-deposits/:employeeId/:projectId', name: 'engineer-deposit-ledger', component: () => import('./views/EngineerDepositLedgerView.vue'), meta: { permission: 'engineer_deposits.view' } },
...
router.beforeEach(async (to) => {
    ...
    if (!to.meta.public && auth.authenticated) {
        ...
        if (to.name === 'module') {
            ...
            if (!item || !auth.hasPermission(item.permission))
                return { name: 'forbidden' };
        }
    }
});
