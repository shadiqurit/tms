...
export interface SitePurchaseRecord {
  id: number;
  projectId: number;
  projectCode: string;
  projectName: string;
...
interface LegacyEmployeeProject { EMPID: number; PRJ_ID: number }

const purchaseSummary: Record<number, [number, number, number, number]> = {
...
export const employeeProjectOptions: EmployeeProjectOption[] = [
  ...(legacyEmployeeProjects.recordset as LegacyEmployeeProject[]),
  ...(legacyEmployeeSites.recordset as LegacyEmployeeProject[]),
...
export const sitePurchaseRecords: SitePurchaseRecord[] = (legacyPurchases.recordset as LegacyPurchase[]).map((item) => {
...
export const demoMaterialLines: MaterialLineRecord[] = [
...
export const demoExpenseLines: SiteExpenseLineRecord[] = [
