...
const saved = ref('');
const error = ref('');
const activeTab = ref(route.query.entry === 'expense' ? 'expenses' : 'materials');
...
const form = reactive({ projectId: Number(route.query.projectId || 0), employeeId: Number(route.query.employeeId || 0), supplierId: null, purchaseNo: '', localSupplier: '', supplierAddress: '', purchaseDate: today, purchaseType: 'local', challanNo: '', challanDate: '', notes: '', status: 'posted' });
