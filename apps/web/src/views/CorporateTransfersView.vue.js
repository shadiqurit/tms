...
import { corporateTransferRecords } from '../data/corporateTransfers';
const transfers = ref(corporateTransferRecords.map((item) => ({ ...item })));
const search = ref('');
...
onMounted(async () => {
    ...
    loading.value = true;
    try {
        transfers.value = (await api('/corporate-transfers')).transfers;
    }
    catch (reason) {
        error.value = reason instanceof Error ? reason.message : 'Could not load corporate transfers.';
    }
    finally {
        loading.value = false;
    }
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.section, __VLS_intrinsicElements.section)({
    ...{ class: "sites-page corporate-transfers-page" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "expense-page-intro panel" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
const __VLS_0 = {}.ArrowLeftRight;
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    placeholder: "Search transfer, source, destination, or site…",
});
(__VLS_ctx.search);
...
if (__VLS_ctx.loading) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.table, __VLS_intrinsicElements.table)({
        ...{ class: "site-table corporate-transfer-table" },
    });
    ...
    for (const [item] of __VLS_getVForSourceType((__VLS_ctx.visible))) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
        (__VLS_ctx.date(item.transferDate));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.strong, __VLS_intrinsicElements.strong)({});
        (item.transferNo || `TRN-${item.id}`);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({});
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "site-project-cell" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.strong, __VLS_intrinsicElements.strong)({});
        (item.fromProjectCode || `#${item.fromProjectId}`);
        ...
        (item.fromSiteName || 'All / source project');
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({});
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "site-project-cell" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.strong, __VLS_intrinsicElements.strong)({});
        (item.receiveProjectCode || `#${item.receiveProjectId}`);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.small, __VLS_intrinsicElements.small)({});
        (item.receiveProjectName);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
            ...{ class: "corporate-site" },
        });
        ...
        (item.receiveSiteName || 'Defined per product line');
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({});
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...
        const __VLS_29 = __VLS_asFunctionalComponent(__VLS_28, new __VLS_28({
            to: (`/purchases/transfers/${item.id}/edit`),
            ...{ class: "card-edit" },
            'aria-label': "Modify corporate transfer",
        }));
...
/** @type {__VLS_StyleScopedClasses['corporate-transfers-page']} */ ;
...
/** @type {__VLS_StyleScopedClasses['corporate-transfer-table']} */ ;
